    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BulkEnquiryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BulkEnquiries", x => x.BulkEnquiryId);
                    table.ForeignKey(
                        name: "FK_BulkEnquiries_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_BulkEnquiries_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductPriceTierId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPriceTiers", x => x.ProductPriceTierId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BulkEnquiries_ProductId",
                table: "BulkEnquiries",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_BulkEnquiries_UserId",
                table: "BulkEnquiries",
                column: "UserId");
